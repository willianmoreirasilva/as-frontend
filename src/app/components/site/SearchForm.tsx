...
export const SearchForm = ({onSearchButton, loading}:Props)=> {
    ...
    return(
        <div>
            ...
            className="w-full p-3 bg-white text-black text-4xl outline-none rounded-lg disabled:opacity-20" 
            autoFocus
            value={cpfInput}
            ...
            text-white text-4xl border-b-4 border-blue-600 active:border-0 disabled:opacity-20"
